...
namespace QuanLiBanHang.Forms
{
    public partial class frmKhachHang : Form
    {
                ...
                try
                {
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            ...
                            {
                                KhachHang kh = new KhachHang();
                                // Gán giá trị cho 3 thuộc tính của khách hàng
                            ...
                            context.SaveChanges();
                            MessageBox.Show("Đã nhập thành công " + table.Rows.Count + " khách hàng.", "Thành công");
                            frmKhachHang_Load(sender, e);
                        }
                    }
                }
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "KhachHang_" + DateTime.Now.ToString("ddMMyyyy") + ".xlsx";
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                new DataColumn("DiaChi", typeof(string))
                    ...
                    using (XLWorkbook wb = new XLWorkbook())
                    {
                        ...
                        sheet.Columns().AdjustToContents(); // Tự căn chỉnh độ rộng cột
                        wb.SaveAs(saveFileDialog.FileName);
                        MessageBox.Show("Xuất dữ liệu khách hàng thành công!", "Thông báo");
                    }
                }
                catch (Exception ex)
                {
